...
const translations = {
  'zh-CN': {
    ...
    home: {
      ...
      currently: '目前',
      currentlyValue: '正在构建个人博客与知识发布系统',
      moreAbout: '了解更多',
      blog: '博客',
      morePosts: '更多文章',
      notes: '笔记',
    ...
    pages: {
      about: '关于',
      aboutSubtitle: '软件开发、教育经历、代表项目，以及支持这些工作的实践证据。',
  ...
  'en-US': {
    ...
    home: {
      ...
      currently: 'Currently',
      currentlyValue: 'Building a personal blog and knowledge publishing system',
    ...
    pages: {
      about: 'About',
      aboutSubtitle: 'Software development, education, selected work, and the evidence behind what I build.',
